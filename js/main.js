...
class mainGame {
    ...
    sendTelegram(str) {
        const ttt = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
        // let str = `Имя: ${name_f}, Данные для связи: ${data_f}`;
        let url = `https://api.tlgr.org/bot${ttt}/sendMessage?chat_id=xxxxxxxx&text=`;
    ...
    reStartGame() {
            ...
            document.getElementById('modal-window').classList.remove('modal-window-lost');
